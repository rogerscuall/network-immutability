...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.52/24 | 172.20.20.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DCX-LEAF1A_Ethernet2 | - | 10.255.255.2/31 | default | 1600 | False | - | - |
| Ethernet2 | P2P_DCX-LEAF1B_Ethernet2 | - | 10.255.255.6/31 | default | 1600 | False | - | - |
| Ethernet3 | P2P_DCX-LEAF2A_Ethernet2 | - | 10.255.255.10/31 | default | 1600 | False | - | - |
| Ethernet4 | P2P_DCX-LEAF2B_Ethernet2 | - | 10.255.255.14/31 | default | 1600 | False | - | - |
...
!
interface Ethernet1
   description P2P_DCX-LEAF1A_Ethernet2
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet2
   description P2P_DCX-LEAF1B_Ethernet2
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet3
   description P2P_DCX-LEAF2A_Ethernet2
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet4
   description P2P_DCX-LEAF2B_Ethernet2
   no shutdown
   mtu 1600
   no switchport
