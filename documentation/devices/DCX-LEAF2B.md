...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.56/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| DCX_L3_LEAF2 | Vlan4094 | 10.255.1.68 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DCX-LEAF2A_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DCX-LEAF2A_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_DCX-leaf2-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
| Ethernet8 | L2_DCX-L2LEAF2A_Ethernet2 | *trunk | *11-13,21,25,31,3401-3403 | *- | *- | 8 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DCX-SPINE1_Ethernet4 | - | 10.255.255.13/31 | default | 1600 | False | - | - |
| Ethernet2 | P2P_DCX-SPINE2_Ethernet4 | - | 10.255.255.15/31 | default | 1600 | False | - | - |
...
!
interface Ethernet1
   description P2P_DCX-SPINE1_Ethernet4
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet2
   description P2P_DCX-SPINE2_Ethernet4
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet3
   description MLAG_DCX-LEAF2A_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_DCX-LEAF2A_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description SERVER_DCX-leaf2-server1_PCI2
   no shutdown
   channel-group 5 mode active
!
interface Ethernet8
   description L2_DCX-L2LEAF2A_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DCX-LEAF2A_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_DCX-LEAF2A_Port-Channel3
   no shutdown
...
interface Port-Channel5
   description PortChannel DCX-leaf2-server1
   no shutdown
...
| 13 | 10.255.0.6:10013 | 10013:10013 | - | - | learned |
| 21 | 10.255.0.6:10021 | 10021:10021 | - | - | learned |
| 25 | 10.255.0.6:10025 | 10025:10025 | - | - | learned |
...
| 3403 | 10.255.0.6:13403 | 13403:13403 | - | - | learned |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DCX-LEAF2A
   ...
   vrf VRF10
      ...
      router-id 10.255.0.6
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.100 description DCX-LEAF2A_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.0.6
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.100 description DCX-LEAF2A_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.0.6:12
      ...
      router-id 10.255.0.6
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.100 description DCX-LEAF2A_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
