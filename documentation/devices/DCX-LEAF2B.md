...
| --------- | --------------- | ------------ | --------- |
| DCX_L3_LEAF2 | Vlan4094 | 10.255.1.68 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_DCX-LEAF2A_Ethernet4 | *trunk | *- | *- | *MLAG | 4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_DCX-LEAF2A_Port-Channel4 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel4
   description MLAG_DCX-LEAF2A_Port-Channel4
   no shutdown
