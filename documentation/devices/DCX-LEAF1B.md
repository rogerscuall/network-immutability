...
| --------- | --------------- | ------------ | --------- |
| DCX_L3_LEAF1 | Vlan4094 | 10.255.1.64 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_DCX-LEAF1A_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_DCX-LEAF1A_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet5 | SERVER_DCX-leaf1-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
| Ethernet8 | L2_DCX-L2LEAF1A_Ethernet2 | *trunk | *11-13,21,25,31,3401-3403 | *- | *- | 8 |
...
!
interface Ethernet3
   description MLAG_DCX-LEAF1A_Ethernet3
   no shutdown
...
!
interface Ethernet8
   description L2_DCX-L2LEAF1A_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_DCX-LEAF1A_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel3
   description MLAG_DCX-LEAF1A_Port-Channel3
   no shutdown
