...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.55/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| DCX_L3_LEAF2 | Vlan4094 | 10.255.1.69 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_DCX-LEAF2B_Ethernet4 | *trunk | *- | *- | *MLAG | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_DCX-SPINE1_Ethernet3 | - | 10.255.255.9/31 | default | 1600 | False | - | - |
| Ethernet2 | P2P_DCX-SPINE2_Ethernet3 | - | 10.255.255.11/31 | default | 1600 | False | - | - |
...
!
interface Ethernet1
   description P2P_DCX-SPINE1_Ethernet3
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet2
   description P2P_DCX-SPINE2_Ethernet3
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet4
   description MLAG_DCX-LEAF2B_Ethernet4
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_DCX-LEAF2B_Port-Channel4 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel4
   description MLAG_DCX-LEAF2B_Port-Channel4
   no shutdown
...
| 13 | 10.255.0.5:10013 | 10013:10013 | - | - | learned |
| 21 | 10.255.0.5:10021 | 10021:10021 | - | - | learned |
| 25 | 10.255.0.5:10025 | 10025:10025 | - | - | learned |
...
| 3403 | 10.255.0.5:13403 | 13403:13403 | - | - | learned |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DCX-LEAF2B
   ...
   vrf VRF10
      ...
      router-id 10.255.0.5
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.101 description DCX-LEAF2B_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.0.5
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.101 description DCX-LEAF2B_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.0.5:12
      ...
      router-id 10.255.0.5
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.101 description DCX-LEAF2B_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
