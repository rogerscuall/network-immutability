...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.53/24 | 172.20.20.1 |
...
| Ethernet8 | L2_DCX-L2LEAF1A_Ethernet1 | *trunk | *11-13,21,25,31,3401-3403 | *- | *- | 8 |
...
!
interface Ethernet1
   description P2P_DCX-SPINE1_Ethernet1
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet2
   description P2P_DCX-SPINE2_Ethernet1
   no shutdown
   mtu 1600
   no switchport
...
!
interface Ethernet8
   description L2_DCX-L2LEAF1A_Ethernet1
   no shutdown
...
| Port-Channel8 | L2_DCX-L2LEAF1A_Port-Channel1 | trunk | 11-13,21,25,31,3401-3403 | - | - | - | - | 8 | - |
...
interface Port-Channel8
   description L2_DCX-L2LEAF1A_Port-Channel1
   no shutdown
...
| 25 | 10.255.0.3:10025 | 10025:10025 | - | - | learned |
...
| 3403 | 10.255.0.3:13403 | 13403:13403 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DCX-LEAF1B
   ...
   neighbor 10.255.255.0 description DCX-SPINE1_Ethernet1
   ...
   vrf VRF10
      ...
      router-id 10.255.0.3
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.97 description DCX-LEAF1B_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.0.3
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.97 description DCX-LEAF1B_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.0.3:12
      ...
      router-id 10.255.0.3
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.97 description DCX-LEAF1B_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
